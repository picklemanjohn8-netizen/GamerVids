...
import { Play, Share2, ShieldCheck, DollarSign, Flame, MoreVertical } from 'lucide-react';
    ...
    >
      ...
      <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-neutral-900 border border-neutral-800 group-hover:border-neutral-700 transition-all duration-300 shadow-md group-hover:shadow-xl">
        ...
        <button
          ...
          className="absolute bottom-2 left-2 p-1.5 rounded-lg bg-black/70 hover:bg-red-600 text-white opacity-0 group-hover:opacity-100 transition-all duration-200 cursor-pointer shadow-md"
          title="Direct Share"
        >
